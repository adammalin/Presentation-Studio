...
export const STUDIO_COMPONENT_ROLES = ["eyebrow", "card-kicker", "card-heading", "card-body", "metric-card", "objective-body", "step-heading", "step-body", "figure-media", "figure-label", "figure-caption", "image-series-media", "image-series-heading", "image-series-body", "logo-grid-item", "technical-annotation", "question-intro", "question-item", "challenge-assertion", "challenge-intro", "challenge-body", "process-icon", "process-input", "process-stage", "process-output", "supporting-copy", "footer-logo", "footer-meta"] as const;
